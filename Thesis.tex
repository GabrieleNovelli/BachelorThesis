...
a\\b
\end{pmatrix}$$
Con almeno uno tra $a,b$ diverso da $0$ in quanto è necessario che $ad-bc=1$ per la condizione $det(A)=1$. Abbiamo trovato $O_{(1,0)}=\{(a,b);\, a,b\in\mathbb{R}\}$. Questo significa che ogni punto di $\mathbb{R}^2-\{(0,0)\}$ appartiene all'orbita di $(1,0)$, cioè l'azione di $SL_2(\mathbb{R})$ su $\mathbb{R}^2-\{(0,0)\}$ è transitiva. E' possibile mostrare lo stesso risultato procedendo al contrario: preso un generico elemento $(a,b)$ troviamo una matrice $A\in SL_2(\mathbb{R})$ tale che 
$$A\begin{pmatrix}
	1\\0
\end{pmatrix}=\begin{pmatrix}
	a\\b
...
\begin{Ex}[Spazio tangente a $GL_n(\mathbb{R})$]
	...
	\\
	Poichè la mappa $det:GL_n(\mathbb{R})\rightarrow\mathbb{R}$ è continua, sapendo che $det(\mathbb{I})\neq 0$, esiste $U_\mathbb{I}$ aperto contenente $\mathbb{I}$ tale che se $A\in U_\mathbb{I}$ allora $det(A)\neq 0$. Sia $B\in M_{n\times n}$ e $\gamma:]-\epsilon,\epsilon[\rightarrow M_{n\times n}$ tale che $\gamma(t)=\mathbb{I}+tB+O(t^2)$. Allora $\gamma(0)=\mathbb{I}$ e $\gamma'(0)=B\in T_\mathbb{I}GL_n(\mathbb{R})$. Scelto $\epsilon>0$ abbastanza piccolo si ha che $det(\mathbb{I}+tB+O(t^2))\neq 0$ per ogni $t\in]-\epsilon,\epsilon[$. Da ciò, $$\mathfrak{gl_n(\mathbb{R})}\cong M_{n\times n}= T_\mathbb{I}GL_n(\mathbb{R})$$.
\end{Ex}
\begin{Ex}[Spazio tangente a $SL_n(\mathbb{R})$]
	...
	Seguendo lo stesso ragionamento dell'esempio precedente e quindi considerando una curva $\gamma:]-\epsilon,\epsilon[\rightarrow M_{n\times n}$ tale che $\gamma(t)=\mathbb{I}+tB+O(t^2)$, è necessario che $det(\mathbb{I}+tB+O(t^2))=1$. Ma $det(\mathbb{I}+tB+O(t^2))=1+tr(B)+O(t^2)$ da cui: $$T_\mathbb{I}SL_n(\mathbb{R})\cong \mathfrak{sl_n(\mathbb{R})}=\{A\in M_{n\times n}|trA=0\}$$ 
\end{Ex}
